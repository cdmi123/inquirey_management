        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div class="row">
              ...
              <div class="col-3">
                <a href="<?php echo site_url('inquiry/justdial')?>" class="btn btn-primary btn-block my-1"><i class="fas fa-plus"></i> Add JD</a>
              </div>
               <div class="col-3">
                <a href="<?php echo site_url('inquiry/call')?>" class="btn btn-primary btn-block my-1"><i class="fas fa-plus"></i> Add Call</a>
              </div>
               <div class="col-3">
                <a href="<?php echo site_url('inquiry/web')?>" class="btn btn-primary btn-block my-1"><i class="fas fa-plus"></i> Add Web</a>
              </div>
            </div>
              ...
              <table id="example2" class="table table-bordered table-hover view-data">
                <thead>
                  ...
                  <tr>
                    ...
                    <td colspan="4"><input type="text" id="autouser" class="form-control" placeholder="Search Keyword" name="search_keyword"></td>
                ...
                <tr style="color: <?php echo $color;?>">
                    ...
                    <td><?php if($info['status']==1 || !empty($demo_details)){ echo $demo_details['demo_start'];}else { echo 'Not Mentioned';}?></td>
               
                    <td><?php echo $status; ?> <?php if(!empty($demo_details)){?><div style="border-top: solid 1px black;margin-top: 5px"><?php echo $demo_details['name']; }?></div> <a href="<?php echo site_url('inquiry/update_offline_decliened_status/'.$info['id']) ?>" class="btn btn-danger">Declined</a></td>
